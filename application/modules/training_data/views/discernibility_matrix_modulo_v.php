        ...
        <div class="col-md-12 col-sm-12 col-xs-12 gutter">
            <div class="sales">
                ...
                <ul class="nav nav-tabs" style="margin-bottom: 20px;">
                  ...
                  <li class="active"><a href="#">Discernibility Matrix Modulo D</a></li>
                </ul>
                <div class="col-md-12" style="margin-bottom:20px;">
                    A = Date, B = Time, C = Region, D = State
                    <div class="col-md-3 col-md-offset-9">
                        <a href="<?php echo site_url(); ?>training_data/discernibilityMatrixModulo" type="button" class="btn btn-primary float-right">Hitung Discernibility Matrix Modulo D</a>
                    </div>
                </div>
                <div class="container">
                    <div class="row">
                        <table id="data_matrix_modulo" class="table-bordered hover" cellspacing="0" width="100%">
                            <thead>
            					<tr>
...
$(document).ready(function() {
	var lastIdx = null;
	var table = $('#data_matrix_modulo').DataTable({
		"ordering" : false,
		"bLengthChange" : false,
		"searching" : false,
		"info" : false,
